      ...
      <div className="max-w-5xl mx-auto px-6">
        ...
        <div className="flex flex-col gap-24">
          {projects.map((p, i) => (
            ...
            >
              <div className="flex-1 bg-white/[0.03] border border-white/5 rounded-2xl aspect-video flex items-center justify-center text-gray-600 text-sm">
              ...
              <div className="flex-1">
                ...
                <div className="flex gap-3">
                  ...
                  <a href={p.code}
                    className="border border-white/10 bg-white/5 hover:bg-white/10 text-white text-sm px-5 py-2.5 rounded-xl transition-all">
                    Ver Código
                  </a>
                </div>
              </div>
